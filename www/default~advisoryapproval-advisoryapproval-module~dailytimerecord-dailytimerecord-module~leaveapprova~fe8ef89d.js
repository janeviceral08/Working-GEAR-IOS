(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~advisoryapproval-advisoryapproval-module~dailytimerecord-dailytimerecord-module~leaveapprova~fe8ef89d"],{
...
var FilterMenuComponent = /** @class */ (function () {
    ...
    FilterMenuComponent.prototype.filterList = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var result, result, result, result, result, result, result, result;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 11:
                        ...
                        return [3 /*break*/, 16];
                    case 12:
                        if (!(this.module == "WorkFromHome")) return [3 /*break*/, 14];
                        result = {
                            'isDismissed': 0,
                            'leaveFrom': this.datepipe.transform(this.leaveFrom, 'MM/dd/yyyy'),
                            'leaveTo': this.datepipe.transform(this.leaveTo, 'MM/dd/yyyy'),
...
//# sourceMappingURL=default~advisoryapproval-advisoryapproval-module~dailytimerecord-dailytimerecord-module~leaveapprova~fe8ef89d.js.map