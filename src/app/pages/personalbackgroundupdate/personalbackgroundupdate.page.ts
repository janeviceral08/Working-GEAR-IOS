...
@Component({
  ...
  templateUrl: './personalbackgroundupdate.page.html',
  styleUrls: ['./personalbackgroundupdate.page.scss'],
})
export class PersonalbackgroundupdatePage implements OnInit {
  ...
  getInfo() {
    this.storage.get(`${Constants.KEY_SESSION}`).then((val) => {
      ...
      this.storage.get(Constants.KEY_SERVER_SETTINGS).then((value) => {
        console.log('httpApi Update: ', `${value[Constants.SERVER_URL]}/api/BasicInfo/GetPersonalInformation`, postData, {})
        this.httpApi.post(`${value[Constants.SERVER_URL]}/api/BasicInfo/GetPersonalInformation`, postData, {})
          .then(data => {
            ...
            if (jsonData['Value']['tblPersonalInfo'] != null || jsonData['Value']['tblPersonalInfo'] != undefined) {
              ...
              this.LastNAME = jsonData['Value']['tblPersonalInfo']['0'].LNAME;
              this.FNAME = jsonData['Value']['tblPersonalInfo']['0'].FNAME;
              this.MIDDLENAME = jsonData['Value']['tblPersonalInfo']['0'].MNAME;
              this.MAIDENNAME = jsonData['Value']['tblPersonalInfo']['0'].MAIDENNAME;
              this.SUFFIX = jsonData['Value']['tblPersonalInfo']['0'].SUFFIX;
              this.TITLE = jsonData['Value']['tblPersonalInfo']['0'].TITLE;
              this.NICKNAME = jsonData['Value']['tblPersonalInfo']['0'].NICKNAME;
              this.BIRTHDAY2 = jsonData['Value']['tblPersonalInfo']['0'].BIRTHDAY2;
              this.AGE = jsonData['Value']['tblPersonalInfo']['0'].AGE;
              this.PLACEOFBIRTH = jsonData['Value']['tblPersonalInfo']['0'].PLACEOFBIRTH;
              this.COUNTRYOFBIRTH = jsonData['Value']['tblPersonalInfo']['0'].COUNTRYOFBIRTH;
              this.SEX = jsonData['Value']['tblPersonalInfo']['0'].SEX;
              this.CIVILSTATUS = jsonData['Value']['tblPersonalInfo']['0'].CIVILSTATUS;
              this.DATEOFMARRIAGE = jsonData['Value']['tblPersonalInfo']['0'].DATEOFMARRIAGE;
              this.NATIONALITY = jsonData['Value']['tblPersonalInfo']['0'].NATIONALITY;
              this.RELIGION = jsonData['Value']['tblPersonalInfo']['0'].RELIGION;
              this.RELIGIONOTHERS = jsonData['Value']['tblPersonalInfo']['0'].RELIGIONOTHERS;
              this.EMAILADD = jsonData['Value']['tblPersonalInfo']['0'].EMAILADD;
            }
            if (jsonData['Value']['tblMobileInfo'] != null || jsonData['Value']['tblMobileInfo'] != undefined) {
              ...
              this.PhoneNUMBER = jsonData['Value']['tblMobileInfo']['0'].NUMBER;
              console.log('this.mobileInfo: ', this.mobileInfo)
            }
